...
public class HibernateDataProviderLab5ManyToOneTwo {
    private static final Logger log = LogManager.getLogger(HibernateDataProviderLab5ManyToOneTwo.class.getName());
