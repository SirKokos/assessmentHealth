package ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.utils;
    ...
    public static SessionFactory getSessionFactory(){
        ...
        try {
            if(sessionFactory == null){
                ...
                metadataSources.addAnnotatedClass(Preparation.class);
                metadataSources.addAnnotatedClass(CalcReport.class);
                metadataSources.addAnnotatedClass(HistoryMedical.class);
