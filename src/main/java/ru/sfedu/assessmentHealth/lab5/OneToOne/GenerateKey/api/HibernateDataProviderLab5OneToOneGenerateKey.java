...
import ru.sfedu.assessmentHealth.lab5.OneToOne.GenerateKey.model.StatusResponse;
import ru.sfedu.assessmentHealth.lab5.OneToOne.GenerateKey.utils.HibernateUtil;


public class HibernateDataProviderLab5OneToOneGenerateKey {
    private static final Logger log = LogManager.getLogger(HibernateDataProviderLab5OneToOneGenerateKey.class.getName());
