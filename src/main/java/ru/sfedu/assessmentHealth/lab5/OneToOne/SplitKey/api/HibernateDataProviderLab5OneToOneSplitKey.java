...
import ru.sfedu.assessmentHealth.lab5.OneToOne.SplitKey.model.StatusResponse;
import ru.sfedu.assessmentHealth.lab5.OneToOne.SplitKey.utils.HibernateUtil;


public class HibernateDataProviderLab5OneToOneSplitKey {
    private static final Logger log = LogManager.getLogger(HibernateDataProviderLab5OneToOneSplitKey.class.getName());
