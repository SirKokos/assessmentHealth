...
public class HibernateDataProviderLab5OneToOneFk {
    private static final Logger log = LogManager.getLogger(HibernateDataProviderLab5OneToOneFk.class.getName());
