...
public class CalcReport extends BaseId {
    ...
    @CsvBindAndSplitByPosition(elementType = ru.sfedu.assessmentHealth.model.Patient.class,converter = ConvertCsvPatient.class,splitOn = "\\s",position = 6)
    protected List<ru.sfedu.assessmentHealth.model.Patient> patient = new ArrayList<>(1);
    @ElementList
    @CsvBindByPosition(position = 7)
    @CsvBindAndSplitByPosition(elementType = ru.sfedu.assessmentHealth.model.Doctor.class,converter = ConvertCsvDoctor.class,splitOn = "\\s",position = 7)
    protected List<ru.sfedu.assessmentHealth.model.Doctor> doctor = new ArrayList<>(1);
    @Element
    ...
    public List<ru.sfedu.assessmentHealth.model.Patient> getPatient() {
        return patient;
    }
    ...
    public List<ru.sfedu.assessmentHealth.model.Doctor> getDoctor() {
        return doctor;
    }
