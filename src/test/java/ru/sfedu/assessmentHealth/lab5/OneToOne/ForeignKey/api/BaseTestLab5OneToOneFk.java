...
import ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.api.HibernateDataProviderLab5OneToOneFk;
import ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.model.*;
import ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.utils.HibernateUtil;
...
@Slf4j
public class BaseTestLab5OneToOneFk {
    HibernateDataProviderLab5OneToOneFk hibernateDataProviderLab5OneToOneFk = new HibernateDataProviderLab5OneToOneFk();
    static {
        PropertyConfig.setConfigPath(Const.NAME_PROPERTY_FILE);
        HibernateUtil.setPathConfig(PropertyConfig.getPropertyValue(Const.LAB5_ONE_TO_ONE_FOREIGN_HBN_CFG,Const.NAME_PROPERTY_FILE));
    }

    public Address getAddress(){
        Address address = new Address();
        address.setCity("Rostov");
        address.setStreet("Zjdanovo");
    ...
    public HistoryMedical getHistoryMedical(){
        HistoryMedical historyMedical = new HistoryMedical();
        historyMedical.setId(1);
        historyMedical.setDateHistory(Date.valueOf("2024-05-03"));
        historyMedical.setFIODoctor("Artem COC");
        historyMedical.setNameDiagnosis("Tuberculeth");
