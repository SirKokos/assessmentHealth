...
import ru.sfedu.assessmentHealth.lab5.OneToOne.SplitKey.api.HibernateDataProviderLab5OneToOneSplitKey;
import ru.sfedu.assessmentHealth.lab5.OneToOne.SplitKey.model.*;
import ru.sfedu.assessmentHealth.lab5.OneToOne.SplitKey.utils.HibernateUtil;
import ru.sfedu.assessmentHealth.lab5.OneToOne.SplitKey.model.Address;
...
@Slf4j
public class BaseTestLab5OneToOneSingleKey {
    HibernateDataProviderLab5OneToOneSplitKey hibernateDataProviderLab5OneToOneSplitKey = new HibernateDataProviderLab5OneToOneSplitKey();
    static {
        PropertyConfig.setConfigPath(Const.NAME_PROPERTY_FILE);
        HibernateUtil.setPathConfig(PropertyConfig.getPropertyValue(Const.LAB5_ONE_TO_ONE_SPLIT_HBN_CFG,Const.NAME_PROPERTY_FILE));
    }
