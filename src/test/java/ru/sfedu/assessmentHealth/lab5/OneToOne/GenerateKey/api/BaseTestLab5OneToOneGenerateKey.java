...
import ru.sfedu.assessmentHealth.lab5.OneToOne.GenerateKey.utils.HibernateUtil;
...
@Slf4j
public class BaseTestLab5OneToOneGenerateKey {
    HibernateDataProviderLab5OneToOneGenerateKey hibernateDataProviderLab5OneToOneGenerateKey = new HibernateDataProviderLab5OneToOneGenerateKey();
    static {
        PropertyConfig.setConfigPath(Const.NAME_PROPERTY_FILE);
        HibernateUtil.setPathConfig(PropertyConfig.getPropertyValue(Const.LAB5_ONE_TO_ONE_GENERATE_HBN_CFG,Const.NAME_PROPERTY_FILE));
    }
