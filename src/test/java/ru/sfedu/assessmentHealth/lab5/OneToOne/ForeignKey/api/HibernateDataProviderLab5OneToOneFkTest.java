package ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.api;

import lombok.extern.slf4j.Slf4j;
import org.junit.jupiter.api.*;
import ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.model.Address;
import ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.model.Doctor;
import ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.model.Person;
import ru.sfedu.assessmentHealth.lab5.OneToOne.ForeignKey.model.StatusResponse;

import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class HibernateDataProviderLab5OneToOneFkTest extends BaseTestLab5OneToOneFk{
    ...
    void saveRecordTest(){
        ...
        StatusResponse expectedDoc = hibernateDataProviderLab5OneToOneFk.saveRecord(doctor);
    ...
    void getRecordTest() {
        ...
        Doctor expectedDoc = (Doctor) hibernateDataProviderLab5OneToOneFk.getRecord(Doctor.class,1);
    ...
    void getRecordTest_negative() {
        ...
        Doctor expectedDoc = (Doctor) hibernateDataProviderLab5OneToOneFk.getRecord(Doctor.class,5);
    ...
    void updateRecordTest() {
        ...
        StatusResponse expected = hibernateDataProviderLab5OneToOneFk.updateRecord(address);
    ...
    void updateRecordTest_negative() {
        ...
        StatusResponse expected = hibernateDataProviderLab5OneToOneFk.updateRecord(doctor);
    ...
    void deleteRecordTest() {
        ...
        doctor.setShippingAddress(address);
        StatusResponse expected = hibernateDataProviderLab5OneToOneFk.deleteRecord(doctor);
        assertEquals(expected,StatusResponse.OK);
    ...
    void deleteRecordTest_negative() {
        ...
        Address address = getAddress();
        address.setId(10);
        StatusResponse expected = hibernateDataProviderLab5OneToOneFk.deleteRecord(address);
        assertEquals( expected,StatusResponse.ERROR);
