...
@Slf4j
public class BaseTestLab5ManyToOneSingle {
    HibernateDataProviderLab5ManyToOneSingle hibernateDataProviderLab5ManyToOneSingle = new HibernateDataProviderLab5ManyToOneSingle();
    static {
        PropertyConfig.setConfigPath(Const.NAME_PROPERTY_FILE);
        HibernateUtil.setPathConfig(PropertyConfig.getPropertyValue(Const.LAB5_MANY_TO_ONE_SINGLE_HBN_CFG,Const.NAME_PROPERTY_FILE));
    }
...
//        List<HistoryMedical> historyMedicals = new ArrayList<>();
//        historyMedicals.add(getHistoryMedical());
//        patient.setHistoryMedicals(historyMedicals);
