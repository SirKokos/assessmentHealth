...
import ru.sfedu.assessmentHealth.lab5.ManyToOne.Two.model.*;
import ru.sfedu.assessmentHealth.lab5.ManyToOne.Two.utils.HibernateUtil;
...
@Slf4j
public class BaseTestLab5ManyToOneTwo {
    HibernateDataProviderLab5ManyToOneTwo hibernateDataProviderLab5ManyToOneTwo = new HibernateDataProviderLab5ManyToOneTwo();
    static {
        PropertyConfig.setConfigPath(Const.NAME_PROPERTY_FILE);
        HibernateUtil.setPathConfig(PropertyConfig.getPropertyValue(Const.LAB5_MANY_TO_ONE_TWO_HBN_CFG,Const.NAME_PROPERTY_FILE));
    }
